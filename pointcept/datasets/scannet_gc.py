...
class ScanNetDataset_GC(Dataset):
    def __init__(
        self,
        split="train",
        ...
        super(ScanNetDataset_GC, self).__init__()
...
@DATASETS.register_module()
class ScanNetDataset_GC_S(Dataset):
    def __init__(
        self,
        split="train",
        data_root="data/scannet_S",
        ...
        super(ScanNetDataset_GC_S, self).__init__()
        self.data_root = data_root if hash_code is not None else data_root + "/" + hash_code
        self.split = split
        self.transform = Compose(transform)
        self.cache = cache
        self.loop = (
