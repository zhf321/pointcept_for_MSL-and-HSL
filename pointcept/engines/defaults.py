...
def default_argument_parser(epilog=None):
    ...
    parser.add_argument(
        "--config-file", 
        # default="/home/zhaohaifeng/code/model/Pointcept-main/configs/s3dis/semseg-u-minkunet34-0-base.py", 
        default="/home/zhaohaifeng/code/model/Pointcept-main/configs/scannet/pretrain-gc-v1m1-0-spunet-base.py",
    ...
    parser.add_argument(
        "--options", 
        default={
            # "save_path": "/home/zhaohaifeng/code/model/Pointcept-main/exp/titan/pretrain-msc-v1m1-0-spunet-base-test",
            # "save_path": "/home/zhaohaifeng/code/model/Pointcept-main/exp/s3dis/0-semseg-u-minkunet34-0-base", 
            "save_path": "/home/zhaohaifeng/code/model/Pointcept-main/exp/scannet/pretrain-gc-v1m1-0-spunet-base", 
            # "resume": True,
            # "weight":"/home/zhaohaifeng/code/model/Pointcept-main/exp/s3dis/0-semseg-minkunet34c-0-base-u-test/model/model_last.pth"
            }, 
        nargs="+", action=DictAction, help="custom options"
    )
    return parser
...
def default_config_parser(file_path, options):
    ...
    if hasattr(cfg.data.train, "pl_path"):
        cfg.data.train.pl_path = os.path.join(cfg.save_path, "pseudo_label") # cfg.data.train.pl_path
        # print(cfg.data.train.pl_path)
...
def default_setup(cfg):
    ...
    cfg.batch_size_clu_per_gpu = (
        cfg.batch_size_clu // world_size if cfg.batch_size_clu is not None else 1
    )
