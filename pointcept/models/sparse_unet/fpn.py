...
class Res16FPNBase(ResNetBase):
    ...
    def forward(self, data_dict):
        ...
        x = in_field.sparse() # Converts the current sparse tensor field to a sparse tensor.
        ...
        dout_b3p8 = dout_b3p8.slice(in_field)

        dout_b2p4 = self.delayer3(out_b2p4)
        dout_b2p4 = dout_b2p4.slice(in_field)

        dout_b1p2 = self.delayer4(out_b1p2)
        dout_b1p2 = dout_b1p2.slice(in_field)
