...
@MODELS.register_module("PointTransformer-Seg66")
class PointTransformerSeg66(PointTransformerSeg):
    def __init__(self, **kwargs):
        super(PointTransformerSeg66, self).__init__(
            Bottleneck, [2, 3, 4, 6, 3], **kwargs
        )
