...
model = dict(
    ...
    backbone=dict(type="MinkUNet34", in_channels=6, out_channels=0),
    criteria=[dict(type="CrossEntropyLoss", loss_weight=1.0, ignore_index=-1, pred_factor=6)],
)
