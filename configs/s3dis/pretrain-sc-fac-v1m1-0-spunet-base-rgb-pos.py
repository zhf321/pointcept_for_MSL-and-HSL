...
# misc custom setting
batch_size = 12  # bs: total bs in all gpus  16
num_worker = 16
mix_prob = 0
empty_cache = False
enable_amp = False
...
data = dict(
    ...
    train=dict(
        ...
        transform=[
            ...
            dict(type="Get_sp_background_mask"),
            ...
            dict(
                ...
                view_keys=("coord", "color", "normal", "origin_coord", "region", # 点级别属性
                           ...
                           "sp_z", "sp_rgb",
                           "sp_wall_mask", "sp_floor_ceil_mask"), # 超点级别属性
                view_trans_cfg=[
                    dict(
                        type="RandomRotate",
                        angle=[-1, 1],
                    ...
                    # dict(type="SquareCrop", block_size=5),
                    dict(type="CenterShift", apply_z=False),
                    dict(type="NormalizeColor"),
                    dict(type="NormalizeSpColor"),
                ],
            ),
            dict(type="Get_intersect_sp", is_sp_attr=True),
            dict(type="ToTensor"),
            dict(
                type="Collect",
                keys=(
                    ...
                    "view1_sp_wall_mask",
                    "view2_sp_wall_mask",
                    "view1_sp_floor_ceil_mask",
                    "view2_sp_floor_ceil_mask",
                ),
                offset_keys_dict=dict(
                    view1_offset="view1_coord", view2_offset="view2_coord"
                ),
                view1_feat_keys=("view1_color", "view1_coord"),
                view2_feat_keys=("view2_color", "view2_coord"),
            ),
        ],
        test_mode=False,
    ),
